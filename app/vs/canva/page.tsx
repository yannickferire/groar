...
const features: Feature[] = [
  ...
  { name: "Starting price", groar: "From $5/mo or lifetime", competitor: "$15/mo" },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer: "GROAR Pro is $5/month or a one-time payment for lifetime access — way cheaper than Canva Pro at $15/month. And with Canva, you still have to design everything yourself, while GROAR gives you ready-to-export metric visuals in seconds.",
  },
  {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <section className="mb-12 md:mb-16 space-y-8">
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                GROAR Pro starts at $5/month (or a one-time payment for lifetime access) and includes everything you need: unlimited exports, premium backgrounds, and no watermark.
                <br /><br />
